...
Um dashboard simples full JS e postgres para uma biblioteca, classificando eles entre os status de:
- 'disponível' para livros disponíveis para empréstimo;
- 'emprestado' para livros que se encontram emprestados por algum estudante;
- 'indisponivel' para livros que estão indisponíveis para empréstimo.


# BD PostgreSQL

## Criação da tabela de livros
Abra o pgAdmin (ou qualquer outra ferramenta que lide com PostgreSQL) e execute o script SQL para criar a tabela de livros:
